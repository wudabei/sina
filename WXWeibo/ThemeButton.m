...
- (void)loadThemeImage {
    ...
    /*
       ...
       if ([image respondsToSelector:@selector(resizableImageWithCapInsets:)]) {
           NSLog(@"resizableImageWithCapInsets");
        image = [image resizableImageWithCapInsets:self.edgeInSert];
        highligtImage = [highligtImage resizableImageWithCapInsets:self.edgeInSert];
        backImage = [backImage resizableImageWithCapInsets:self.edgeInSert];
        backHighligtImage = [backHighligtImage resizableImageWithCapInsets:self.edgeInSert];
    }
    */
    
        NSLog(@"stretchableImageWithLeftCapWidth");
...
- (void)setEdgeInSert:(UIEdgeInsets)edgeInSert {
